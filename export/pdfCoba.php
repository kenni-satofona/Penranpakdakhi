...
<page backtop="14mm" backbottom="14mm" backleft="1mm" backright="10mm">
    ...
    <table class="page_header">
        <tr>
            <td style="text-align: left;    width: 10%">Penran - Dakhi</td>
            <td style="text-align: center;    width: 80%">LAPORAN PENDAPATAN</td>
...
<table>
    ...
    <td align="center" style="width: 800px;"><font style="font-size: 18px"><br><b>Laporan Pencatatan Keuangan Harian</b></font>
        <br><br>Monitoring keuangan harian anda dengan Penran - Dakhi untuk mempermudah pengelolaan keuangan anda 
...
<table class="tabel2">
    ...
    <tr>
        ...
        <td style="text-align: center; background: #ddd"><b>Sumber Pendapatan</b></td>
        <td style="text-align: center; background: #ddd"><b>?th?Keterangan Pendapatan</b></td>
        <td style="text-align: center; background: #ddd"><b>Jumlah Pendapatan</b></td>
    </tr>
    </thead>
...
try
{
    ...
    $html2pdf->Output('Laporan_pendapatan.pdf');
}
