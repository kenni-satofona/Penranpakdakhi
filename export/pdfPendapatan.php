...
if (isset($_POST["pdf"])) {
     ...
     $obj_pdf->SetTitle("Laporan Pendapatan Keuangan");
     ...
     $content = '';
     $content .= '  
     <h4 align="center">Laporan Pendapatan Keuangan</h4><br/> 
     <table border="1" cellspacing="0" cellpadding="3">  
     <tr>  
          <th width="5%">No.</th>   
          <th width="14%">Tanggal</th>
          <th width="28%">Sumber Pendapatan</th>
          <th width="28%">Keterangan Pendapatan</th>
          <th width="25%">Jumlah Pendapatan</th>
     </tr>  
     ';
     $content .= fetchData();
     $content .= '</table>';
     $obj_pdf->writeHTML($content);
     $obj_pdf->Output('Laporan Pendapatan Keuangan.pdf', 'I');
}
?>