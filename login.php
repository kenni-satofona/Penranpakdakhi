...
function login($data) {
  ...
  if ($username === 'pakdakhi' && $password === 'dakhi123') {
      $_SESSION['login'] = true;
      header("Location: dashboard"); // redirect ke halaman dashboard setelah login
      exit;
  } else {
      echo '<script>swal("Gagal","Username atau password salah!","error");</script>';
  }
}
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan Penran - Dakhi</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Login untuk gunakan Penran - Dakhi</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
                ...
                <form method="POST">
                  ...
                  <div class="form-group">
                    <label class="mz-check">
                      <input type="checkbox" name="ingatkansaya">
                      <i class="mz-blue"></i>
                      Ingatkan Saya
                    </label>
                  </div>
