...
<?php if($jenis == 'pendapatan' && $tanggalAwal != '' && $tanggalAkhir != '') : ?>
    <div class="headline">
    ...
    <!-- export -->
    <form action="export/excelPendapatan.php?jenis=<?= $jenis ?>&awal=<?= $tanggalAwal ?>&akhir=<?= $tanggalAkhir ?>&username=<?= $username ?>" method="post">
    ...
    <form action="export/pdfPendapatan.php?jenis=<?= $jenis ?>&awal=<?= $tanggalAwal ?>&akhir=<?= $tanggalAkhir ?>&username=<?= $username ?>" method="post">
    ...
    <div class="row">
        <div class="col-lg-12 judul">
            <h2 class="text-center judul-chart">Diagram Pendapatan</h2>
            <hr>
        </div>
    </div>
...
<?php 
    require '../function/diagramPendapatan.php'; 
