<?php 
    ...
    $totalPendapatan = query("SELECT * FROM pendapatan WHERE username = '$ambilNama'");
    $totalPengeluaran = query("SELECT * FROM pengeluaran WHERE username = '$ambilNama'");
    
    foreach ( $totalPendapatan as $rowMasuk ) {
...
<head>
    ...
    <title>Penran-Dakhi - Dashboard</title>
...
<body>
    <div class="header">
        ...
        <h3 class="text-secondary font-weight-bold float-left logo">Penran</h3>
        <h3 class="text-secondary float-left logo2">- Dakhi</h3>
        <a href="logout">
            <div class="logout">
            ...
            <div class="konten_dalem khusus3">
                ...
                <div class="container" id="container" style="border: none;">
                    <div class="row tampilCardview" id="row">
                                ...
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center tulisan">
                                            <div class="numbers">
                                                <p class="card-category ket head">Saldo Pak Dakhi</p>
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPendapatan" style="text-decoration: none;">
                                <div class="card card-stats card-warning" style="background: #5db85b;">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-7 d-flex align-items-center tulisan">
                                                <div class="numbers">
                                                    <p class="card-category ket head">Pendapatan</p>
                                                    <?php foreach ($totalPedapatan as $row) : ?>
                                                        <?php
                                                            $hargaPendapatan[] = $row["jumlah"];
                                                            $hargaConvert = str_replace('.', '', $hargaPendapatan);
