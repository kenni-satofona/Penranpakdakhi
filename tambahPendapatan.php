...
<head>
    ...
    <title>Penran-Dakhi - Tambah Data</title>
    ...
    <div class="main-content">
        <div class="konten">
            <div class="konten_dalem">
                <h2 class="head" style="color: #4b4f58;">Tambah Data Pendapatan</h2>
                <hr style="margin-top: -5px;">
                <div class="headline">
                    <h5>Tambah Data Pendapatan</h5>
                </div>
                <div class="container">
                    <div class="konten_isi">
                        <table class="table-sm">
                            ...
                            <form class="form-text" action="" method="post">
                                <tr>
                                    <td>Masukkan Tanggal Pendapatan</td>
                                    <td>:</td>
                                    <td><input class="form-control" type="date" value="<?= $today ?>" name="tanggal"
                                            required></td>
                                </tr>
                                <tr>
                                    <td>Masukkan Sumber Pendapatan</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    <td>Masukkan Jumlah Pendapatan</td>
                                    <td>:</td>
