    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [
                <?php 
                $atm = mysqli_query($koneksi,"SELECT * FROM pendapatan WHERE username = '$username' AND (sumber='ATM' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir')");
                echo mysqli_num_rows($atm);
                ?>, 
                <?php 
                $pemberian = mysqli_query($koneksi,"SELECT * FROM pendapatan WHERE username = '$username' AND (sumber='Pemberian' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir')");
                echo mysqli_num_rows($pemberian);
                ?>, 
                <?php 
                $piutang = mysqli_query($koneksi,"SELECT * FROM pendapatan WHERE username = '$username' AND (sumber='Piutang' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir')");
                echo mysqli_num_rows($piutang);
                ?>, 
                <?php 
                $laba = mysqli_query($koneksi,"SELECT * FROM pendapatan WHERE username = '$username' AND (sumber='Laba penjualan' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir')");
                echo mysqli_num_rows($laba);
                ?>, 
                <?php 
                $pekerjaan = mysqli_query($koneksi,"SELECT * FROM pendapatan WHERE username = '$username' AND (sumber='Pekerjaan' AND tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir')");
