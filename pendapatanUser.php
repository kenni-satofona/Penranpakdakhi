...
$jumlahTabel = 5;
$jumlahData = count(query("SELECT * FROM pendapatan WHERE username = '$username'"));
$jumlahHalaman = ceil($jumlahData / $jumlahTabel);
$halamanAktif = (isset($_GET['halaman'])) ? $_GET['halaman'] : 1;
$awalData = ($jumlahTabel * $halamanAktif) - $jumlahTabel;

$pemasukkan = query("SELECT * FROM pendapatan WHERE username = '$username' LIMIT $awalData, $jumlahTabel");
///konfigurasi pagenation
?>
    ...
    <div class="sidebar">
        <nav>
            <ul>
                ...
                <!-- dashboard -->
                <a href="pendapatanUser?username=<?= $username ?>&idUser=<?= $idUser ?>" style="text-decoration: none;">
